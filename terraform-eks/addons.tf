...
module "irsa_ebs_csi" {
    ...
    create_role                     = true
    role_name                       = "AmazonEKSTFEBSCSIRole-${module.eks_cluster.eks_cluster_id}"
    provider_url                    = module.eks_cluster.eks_cluster_identity_oidc_issuer # module.eks.oidc_provider
